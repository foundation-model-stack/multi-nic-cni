...
| Test CIDR Handler\t/Handler functions/SyncAllPendingCustomCR/syncWithMultinicNetwork/deletePendingCIDR | should delete CIDR when no corresponding MultiNicNetwork exists | /home/cbis-admin/set_version/multi-nic-cni/controllers/cidr_handler_test.go |
| Test CIDR Handler\t/Handler functions/SyncAllPendingCustomCR/syncWithMultinicNetwork/deletePendingCIDR | should keep CIDR when corresponding MultiNicNetwork exists | /home/cbis-admin/set_version/multi-nic-cni/controllers/cidr_handler_test.go |
| Test CIDR Handler\t/Handler functions/SyncAllPendingCustomCR/syncWithMultinicNetwork/deletePendingCIDR | should sync network attachments and update internal state | /home/cbis-admin/set_version/multi-nic-cni/controllers/cidr_handler_test.go |
| Test CIDR Handler\t/Util functions/GetAllNetAddrs | returns all unique network addresses from HostInterfaceHandler | /home/cbis-admin/set_version/multi-nic-cni/controllers/cidr_handler_test.go |
